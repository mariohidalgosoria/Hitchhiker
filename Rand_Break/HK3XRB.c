...
int main(void) 
{
  ...
  int ini=1;
  int fin=2;//number of different systems simulated
  FILE *dat=fopen("HK3XIRBR.dat","w");//data file of the initial condition in the lattice, just for checking
  FILE *datos=fopen("HK3XTRBR.dat","w");//data file for the final sizes in the lattice
