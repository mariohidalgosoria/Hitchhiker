...
run as: ./HKD > xRi.dat
then  xR.dat has all the relative displacement for all the different
...
cat xR1.dat xR2.dat xR3.dat xR4.dat xR5.dat xR6.dat xR7.dat xR8.dat xR9.dat xR10.dat> xRtime.dat 
 */
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
...
#define ID 1073//number of different size molecules in  the lattice saved in HK3XTR1.dat  
...
int main(void) 
{
  ...
  sprintf(nom,"HK3XTR1.dat");//file with the initial configuration
